...
from database.dashboard.dashboard_reactivos import (
    obtener_dashboard_reactivos,
)
...
class TarjetaIndicador(ctk.CTkFrame):
    """
    Tarjeta visual para mostrar un indicador principal.
    """
...
class PanelDashboardReactivos(ctk.CTkFrame):
    """
    Panel de estadísticas de reactivos.
    """
    ...
    def _cargar_datos(self):
        """
        Consulta toda la información del dashboard.
        """

        try:
            self.datos = obtener_dashboard_reactivos()

        except Exception as error:
            print(
                "\n========== ERROR CARGANDO DASHBOARD DE REACTIVOS =========="
            )
            print(error)
            print(
                "===========================================================\n"
    ...
    def _crear_indicadores(self):
        ...
        tarjetas = (
            (
                ...
                "📋",
                ACCENT,
                "Filas de reactivos almacenadas",
            ),
            (
    ...
    def _crear_ranking_reactivos(self):
        ...
        seccion = SeccionDashboard(
            self,
            titulo="Reactivos con mayor cantidad acumulada",
            subtitulo=(
                "Ranking según la suma de cantidades registradas"
            ),
        )
        ...
        for indice, reactivo in enumerate(
            ...
            fila = FilaEstadistica(
                ...
                detalle=(
                    f"{formatear_numero(reactivo.get('registros', 0))} "
                    "registros"
                ),
                color=color,
            )
    ...
    def _crear_distribucion_laboratorios(self):
        ...
        seccion = SeccionDashboard(
            self,
            titulo="Reactivos por laboratorio",
            subtitulo=(
        ...
        for indice, item in enumerate(registros):
            ...
            barra = BarraProporcional(
                ...
                maximo=maximo,
                detalle=(
                    f"{formatear_numero(item.get('reactivos_diferentes', 0))} "
                    "reactivos diferentes · "
    ...
    def _crear_distribucion_carreras(self):
        ...
        seccion = SeccionDashboard(
            ...
            subtitulo=(
                "Uso acumulado de reactivos según la carrera registrada"
            ),
        )
    ...
    def _crear_actividad_mensual(self):
        ...
        seccion = SeccionDashboard(
            ...
            subtitulo=(
                "Cantidades de reactivos registradas durante "
    ...
    def _crear_ultimos_registros(self):
        ...
        seccion = SeccionDashboard(
            self,
            titulo="Últimos reactivos registrados",
            subtitulo=(
        ...
        if not registros:
            self._mostrar_sin_datos(
                seccion.contenido,
                "No existen reactivos recientes.",
            )
            return
    ...
    def actualizar(self):
        """
        Recarga los datos y reconstruye completamente el panel.
        """
